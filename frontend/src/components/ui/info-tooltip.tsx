  ...
  return (
    <span className="relative inline-flex">
      ...
      {open ? (
        <span
          className={[
            "pointer-events-none absolute z-20 w-60 rounded-[18px] border border-[color:rgba(255,255,255,0.08)] bg-[linear-gradient(180deg,rgba(41,28,36,0.98),rgba(18,12,18,0.96))] px-3 py-2 text-xs leading-6 text-[color:#f7f2ea] shadow-[0_22px_48px_rgba(16,14,11,0.28)]",
            side === "right"
