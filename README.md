...
- `¿Qué pasó el 2026-02-10?`  `Hipótesis: no` · `Web: no`
- `Compáreme 2026-02-10 vs 2026-02-11.`  `Hipótesis: no` · `Web: no`
- `Entrégueme conclusiones claras sobre cómo se comporta entre semana vs fines de semana la cobertura.`  `Hipótesis: no` · `Web: no`
- `¿Qué horas suelen ser más altas?`  `Hipótesis: no` · `Web: no`
- `¿Cuál fue la hora con menor cobertura el 11 de febrero?`  `Hipótesis: no` · `Web: no`
- `¿Qué tan completo está el dataset entre 2026-02-10 y 2026-02-10?`  `Hipótesis: no` · `Web: no`
- `Revise las anomalías horarias del rango.`  `Hipótesis: no` · `Web: no`
- `Podría entregarme un gráfico que compare la cobertura total de todos los días que tenemos en febrero.`  `Hipótesis: no` · `Web: no`
- `¿Podría generarme ahora una gráfica que compare el día de menor cobertura con el promedio de los demás?`  `Hipótesis: no` · `Web: no`
- `El 11 de febrero es el día con menor cobertura. ¿Podría revisar y darme posibles razones externas a los datos de por qué ese día en Latinoamérica la cobertura fue baja? ¿Podríamos ver si llovió y si esa puede ser una buena razón?`  `Hipótesis: sí` · `Web: sí`

Para un catálogo más amplio y organizado por tipo de demo, revise [docs/CHATBOT_GUIDE.md](docs/CHATBOT_GUIDE.md).
...
- `¿Qué tienda tiene la peor disponibilidad?`
